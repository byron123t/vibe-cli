...
class AgentSession(ABC):
    ...
    def __init__(
        ...
        self.output_tokens: int = 0   # tokens generated by the model (populated by subclasses)
        self.input_tokens:  int = 0   # tokens sent to the model (populated by subclasses)
        self.active_model:  str = ""  # model name reported by the agent (populated by subclasses)

...
│   ├── themes.py                # UI themes
│   └── screens/
│       ├── command_palette.py   # Command palette screen
│       ├── directory_picker.py  # Filesystem navigator modal
│       └── misc_screens.py      # Other modal screens
│
├── core/
│   ├── project_manager.py       # Project list, persistence, active file tracking
│   ├── session_store.py         # Persist/restore UI session state
│   ├── openclaw_config.py       # OpenClaw configuration
│   ├── openclaw_gateway.py      # Gateway client for OpenClaw
│   └── ssh_mount.py             # SSH mounting for remote projects
│
├── terminal/
...
│   ├── openclaw_session.py      # OpenClaw CLI wrapper
...
│   ├── obsidian.py              # External Obsidian vault integration
│   ├── brain_importer.py        # Import .md files into vault
│   └── compactor.py             # Note compaction/optimization
│
├── graph/
...
└── tests/
    ...
    ├── test_linker_linter.py
    ├── test_memory_vault.py
    ├── test_note.py
    ├── test_personalization_graph.py
    ├── test_profile_analyzer.py
    ├── test_refactoring.py
    ├── test_run_log.py
    ├── test_session_store_predictor.py
...
| `ShortcutsBar` | `#shortcuts-bar` | Bottom bar showing available shortcuts |
...
| `OpenClawInboxPanel` | `#inbox-panel` | OpenClaw channels/inbox (toggle: `c`) |
| `ObsidianPanel` | `#obsidian-panel` | External Obsidian vault browser (toggle: `O`) |
...
| `i` | Enter file edit mode (editor must be visible) |
